...
app.listen(PORT, () => {
  ...
  const PRICE_UPDATE_INTERVAL = parseInt(process.env.PRICE_UPDATE_INTERVAL) || 300000;
  setInterval(updateMarketData, PRICE_UPDATE_INTERVAL);

  console.log(`⏱️  Market data updates every ${PRICE_UPDATE_INTERVAL / 1000}s for subscribers`);
});
