...
const navItems = [
  { title: "Dashboard", url: "/", icon: LayoutIcon, locked: false },
  { title: "Markets", url: "/markets", icon: BracketsIcon, locked: false },
  { title: "Swap", url: "/swap", icon: EmailIcon, locked: false },
];
